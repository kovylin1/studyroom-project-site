...
MPW и ILAC под неё проходят.

**Решение владельца 2026-08-03: MPW и ILAC держим** — при живом прецеденте выкидывать
их непоследовательно. Остальные восемь не заводим.

**Решение владельца 2026-08-03 по PHBS: заводим отдельной карточкой,** не дожидаясь
головной карточки Пекинского университета. Саму карточку ПУ владелец тоже хочет,
но собрать её не из чего — у QS её нет; заведена задачей в `BACKLOG.md`
(нужен отдельный сбор с `pku.edu.cn`).

**Итого под заведение 9 записей: 7 вузов + MPW + ILAC.**
