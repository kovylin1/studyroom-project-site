...
| **Сверено с источником** | **461** |
| Сверить не с чем: источник за логином | 227 (QS, IAPro) |
| Сверить не с чем: источник без программ | 11 (Navitas, CATS) |
| Сверить не с чем: источник готов, выгрузки по вузу нет | 9 |
| Программ в каталоге (сверенные вузы) | 57600 |
| Программ у источников (объединение) | 51658 |
| Совпало названий | 35979 (из них по написанию: 356) |
...
Кейсов в панель: **2113** — kompas_programs_missing 255, kompas_programs_extra 333, kompas_fee_mismatch 1075, kompas_campus_missing 56, kompas_fee_absent 340, kompas_fee_currency 11, kompas_fee_mismatch_rest 32, kompas_no_extract 9, kompas_source_blocked 1, kompas_source_empty 1.
