> **УСТАРЕЛ на 2026-08-23.** Разряды A–D разобраны заведением 35 карточек
> (коммит `d8fddaaa`) и слиянием SRH. E закрыт городами от владельца 23.08,
> F закрыт пометкой `noPrograms`. Осталась одна непривязанная выгрузка —
> Oxford International (North America Pathway), ждёт города. Актуальное — в `Plan.md`.
