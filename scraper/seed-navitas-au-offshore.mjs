...
const SG_UNIS = [
  {
    ...
    feeBand: {
      ...
      'utp-business': 25500,
      'utp-it': 26500,
      'utp-engineering': 27500,
      'utp-arts': 25500,
      'bachelor-business': 28500,
      'bachelor-finance': 28500,
      'bachelor-marketing': 28500,
      'bachelor-hospitality': 28500,
      'bachelor-it': 31500,
      'bachelor-cyber': 32000,
      'bachelor-engineering': 33500,
      'bachelor-arts': 26500,
      'bachelor-comm': 27500,
      'bachelor-design': 27500,
      'master-business': 32500,
      'master-finance': 33500,
      'master-it': 35500,
      'master-engineering': 36500,
      'master-arts': 30500,
    },
    paragraphs: [
    ...
    accommodation: [
      { name: 'Curtin Singapore Partner Residences (Science Park)', price: 'от AU$650/мес', text: 'Партнёрские студенческие резиденции у кампуса в Singapore Science Park — комнаты с общей кухней.' },
      { name: 'Lyf Funan / Lyf One-North (Ascott student living)', price: 'от AU$850/мес', text: 'Premium частные резиденции Ascott — современные студии для студентов в центре Сингапура.' },
      ...
      { name: 'Homestay через Curtin Singapore', price: 'от AU$900/мес', text: 'Singapore хост-семья — питание и комната, помогает быстрее адаптироваться.' },
    ],
    campuses: [
      { title: 'Curtin Singapore Campus', sub: '10 Science Park Road, Singapore Science Park II', text: 'Современный кампус в Singapore Science Park. Аудитории, библиотека, computer labs, студенческие пространства.' },
    ],
    extraScholarships: [
      {
      ...
      {
        name: 'Curtin Singapore Excellence Scholarship',
        nameRu: 'Curtin Singapore Excellence Scholarship',
        amount: 'до AU$5,000',
        description: 'For top international applicants progressing into a Curtin Singapore Bachelor degree.',
        descriptionRu: 'Для лучших международных абитуриентов, поступающих на бакалавриат Curtin Singapore.',
        url: 'https://curtin.edu.sg/scholarships/',
      },
      {
        name: 'Curtin Alumni Scholarship',
        nameRu: 'Curtin Alumni Scholarship',
        amount: '10% discount',
        description: 'Discount for direct relatives of Curtin alumni studying at Curtin Singapore.',
        descriptionRu: 'Скидка для родственников выпускников Curtin, обучающихся в Curtin Singapore.',
        url: 'https://curtin.edu.sg/scholarships/',
      },
      {
        name: 'Curtin Sports Excellence Scholarship',
        nameRu: 'Curtin Sports Excellence Scholarship',
        amount: 'до AU$2,500',
        description: 'For international students with national-level sporting achievements.',
        descriptionRu: 'Для международных студентов с национальным уровнем спортивных достижений.',
        url: 'https://curtin.edu.sg/scholarships/',
      },
    ],
    pathwayPrograms: {
      'Foundation Studies': [
        ...
        ['Foundation Studies — Business and Commerce', 'foundation', 1, 'foundation'],
        ['Foundation Studies — Technology', 'foundation', 1, 'foundation'],
      ],
      'Diploma in Business and Commerce': [
        ...
        ['Diploma of Management', 'foundation', 0.67, 'utp-business'],
      ],
      'Diploma in Computing and Engineering': [
        ['Diploma of Information Technology', 'foundation', 0.67, 'utp-it'],
        ['Diploma of Engineering', 'foundation', 0.67, 'utp-engineering'],
      ],
      'Diploma in Arts and Communication': [
        ['Diploma of Arts (Mass Communication)', 'foundation', 0.67, 'utp-arts'],
      ],
    },
    bachelorPrograms: {
      'Curtin Business School': [
        ...
        ['Bachelor of Commerce (Banking)', 'bachelor', 3, 'bachelor-finance'],
      ...
      'Computing and IT': [
        ...
        ['Bachelor of Information Technology (Cyber Security)', 'bachelor', 3, 'bachelor-cyber'],
        ['Bachelor of Information Technology (Business Information Systems)', 'bachelor', 3, 'bachelor-it'],
      ],
      'Engineering': [
        ...
        ['Bachelor of Engineering (Honours) (Electronics and Communications)', 'bachelor', 4, 'bachelor-engineering'],
        ['Bachelor of Engineering (Honours) (Civil and Construction)', 'bachelor', 4, 'bachelor-engineering'],
      ],
      'Arts and Communication': [
        ['Bachelor of Arts (Mass Communication)', 'bachelor', 3, 'bachelor-comm'],
        ['Bachelor of Arts (Public Relations)', 'bachelor', 3, 'bachelor-comm'],
        ['Bachelor of Arts (Journalism)', 'bachelor', 3, 'bachelor-comm'],
        ['Bachelor of Arts (Advertising and Design)', 'bachelor', 3, 'bachelor-design'],
        ['Bachelor of Arts (Digital Design)', 'bachelor', 3, 'bachelor-design'],
      ],
    },
    masterPrograms: {
      'Curtin Business School': [
        ['Master of Commerce (Applied Finance)', 'master', 1.5, 'master-finance'],
        ['Master of Commerce (Marketing)', 'master', 1.5, 'master-business'],
        ['Master of International Business', 'master', 1.5, 'master-business'],
        ['Master of Business Administration', 'master', 2, 'master-business'],
        ['Master of Human Resources', 'master', 1.5, 'master-business'],
      ...
      'Computing and IT': [
        ...
        ['Master of Cyber Security', 'master', 1.5, 'master-it'],
        ['Master of Predictive Analytics', 'master', 1.5, 'master-it'],
      ],
...
const LK_UNIS = [
  {
    ...
    feeBand: {
      ...
      'bachelor-finance': 11500,
      'bachelor-marketing': 11500,
      'bachelor-it': 13500,
      'bachelor-cyber': 13500,
      'bachelor-data': 13500,
      'bachelor-comm': 11500,
      'bachelor-engineering': 14500,
      'master-business': 14500,
      'master-finance': 14500,
      'master-it': 16500,
      'master-cyber': 16500,
    },
    paragraphs: [
    ...
    accommodation: [
      ...
      { name: 'Homestay через ECU Sri Lanka', price: 'от AU$320/мес', text: 'Местная Sri Lankan хост-семья — питание и комната, помогает быстрее адаптироваться.' },
      { name: 'Bambalapitiya Hostels', price: 'от AU$200/мес', text: 'Бюджетные общежития в Bambalapitiya — для self-catered студентов.' },
    ],
    campuses: [
    ...
    extraScholarships: [
      ...
      {
        name: 'ECU Sri Lanka Pathway Progression Award',
        nameRu: 'ECU Sri Lanka Pathway Progression Award',
        amount: 'до AU$1,500',
        description: 'For top Foundation/Diploma students progressing to ECU Sri Lanka Bachelor.',
        descriptionRu: 'Для лучших Foundation/Diploma студентов, переходящих в ECU Sri Lanka Bachelor.',
        url: 'https://www.ecu.edu.lk/scholarships/',
      },
      {
        name: 'ECU Transfer to Perth Award',
        nameRu: 'ECU Transfer to Perth Award',
        amount: 'до AU$3,000',
        description: 'For ECU Sri Lanka students who transfer to ECU Perth campus to complete Bachelor.',
        descriptionRu: 'Для студентов ECU Sri Lanka, которые переводятся в ECU Perth для завершения бакалавриата.',
        url: 'https://www.ecu.edu.au/international/scholarships',
      },
      {
        name: 'ECU Sri Lanka Sibling Discount',
        nameRu: 'ECU Sri Lanka Sibling Discount',
        amount: '10% discount',
        description: 'Tuition discount for siblings studying at ECU Sri Lanka simultaneously.',
        descriptionRu: 'Скидка на обучение для братьев/сестёр, обучающихся в ECU Sri Lanka одновременно.',
        url: 'https://www.ecu.edu.lk/scholarships/',
      },
    ],
    pathwayPrograms: {
      'Foundation Studies': [
        ...
        ['Foundation Programme — Communications', 'foundation', 1, 'foundation'],
      ],
      'Diploma Programs': [
        ['Diploma of Commerce', 'foundation', 1, 'utp-business'],
        ['Diploma of Information Technology', 'foundation', 1, 'utp-it'],
        ['Diploma of Communications', 'foundation', 1, 'utp-comm'],
      ],
    },
    bachelorPrograms: {
      'Business': [
        ...
        ['Bachelor of Commerce (Management)', 'bachelor', 3, 'bachelor-business'],
        ['Bachelor of Commerce (Marketing)', 'bachelor', 3, 'bachelor-marketing'],
        ['Bachelor of Commerce (Hospitality and Tourism Management)', 'bachelor', 3, 'bachelor-business'],
      ...
      'Computing and IT': [
        ...
        ['Bachelor of Science (Cyber Security)', 'bachelor', 3, 'bachelor-cyber'],
        ['Bachelor of Information Technology (Software Engineering)', 'bachelor', 3, 'bachelor-it'],
        ['Bachelor of Data Science', 'bachelor', 3, 'bachelor-data'],
      ],
      'Communications': [
        ['Bachelor of Communications', 'bachelor', 3, 'bachelor-comm'],
        ['Bachelor of Communications (Public Relations)', 'bachelor', 3, 'bachelor-comm'],
        ['Bachelor of Communications (Advertising)', 'bachelor', 3, 'bachelor-comm'],
      ],
      'Engineering': [
        ['Bachelor of Engineering (Electrical)', 'bachelor', 4, 'bachelor-engineering'],
        ['Bachelor of Engineering (Electronics and Communications)', 'bachelor', 4, 'bachelor-engineering'],
      ],
    },
    masterPrograms: {
      'Business': [
        ...
        ['Master of Professional Accounting', 'master', 1.5, 'master-business'],
        ['Master of Finance', 'master', 1.5, 'master-finance'],
      ],
      'Information Technology': [
        ['Master of Information Technology', 'master', 1.5, 'master-it'],
        ['Master of Cyber Security', 'master', 1.5, 'master-cyber'],
      ],
    },
  },
];
...
const AE_UNIS = [
  {
    ...
    feeBand: {
      ...
      'bachelor-finance': 16500,
      'bachelor-marketing': 16500,
      'bachelor-tourism': 16500,
      'bachelor-it': 18500,
      'bachelor-cyber': 18800,
      'bachelor-data': 18800,
      'bachelor-arts': 14500,
      'bachelor-media': 16500,
      'bachelor-comm': 16500,
      'bachelor-journalism': 16500,
      'master-business': 19500,
      'master-finance': 20000,
      'master-it': 21500,
      'master-cyber': 22000,
      'master-comm': 19500,
    },
    ...
    accommodation: [
      { name: 'Murdoch Dubai Partner Residences (DIAC)', price: 'от AU$520/мес', text: 'Партнёрские студенческие резиденции в Dubai International Academic City — рядом с кампусом.' },
      { name: 'Uninest Student Residences (DIAC)', price: 'от AU$600/мес', text: 'Premium private резиденция в DIAC — современные студии с фитнесом и study lounges.' },
      ...
      { name: 'Myne Student Residence', price: 'от AU$550/мес', text: 'Студенческая резиденция Myne в Academic City — комнаты и студии для международных студентов.' },
      { name: 'Homestay через Murdoch Dubai', price: 'от AU$700/мес', text: 'Хост-семья в Дубае — питание и комната, помогает быстрее адаптироваться.' },
    ],
    campuses: [
    ...
    extraScholarships: [
      ...
      {
        name: 'Murdoch Dubai Vice-Chancellor International Scholarship',
        nameRu: 'Murdoch Dubai Vice-Chancellor International Scholarship',
        amount: 'до AU$5,000',
        description: 'Awarded to top international undergraduate applicants based on academic merit.',
        descriptionRu: 'Награждается лучшим международным абитуриентам бакалавриата на основе академических достижений.',
        url: 'https://www.murdochuniversitydubai.com/scholarships/',
      },
      {
        name: 'Murdoch Dubai Foundation Progression Scholarship',
        nameRu: 'Murdoch Dubai Foundation Progression Scholarship',
        amount: 'до AU$2,000',
        description: 'For high-achieving Foundation/Diploma students progressing to Murdoch Dubai Bachelor.',
        descriptionRu: 'Для высокоуспевающих Foundation/Diploma студентов, переходящих в бакалавриат Murdoch Dubai.',
        url: 'https://www.murdochuniversitydubai.com/scholarships/',
      },
      {
        name: 'Murdoch Dubai Sibling Discount',
        nameRu: 'Murdoch Dubai Sibling Discount',
        amount: '10% discount',
        description: 'Discount for siblings studying at Murdoch Dubai simultaneously.',
        descriptionRu: 'Скидка на обучение для братьев/сестёр, обучающихся в Murdoch Dubai одновременно.',
        url: 'https://www.murdochuniversitydubai.com/scholarships/',
      },
      {
        name: 'Murdoch Dubai Sports Excellence Award',
        nameRu: 'Murdoch Dubai Sports Excellence Award',
        amount: 'до AU$2,500',
        description: 'For international students with national-level sports achievements.',
        descriptionRu: 'Для международных студентов с национальным уровнем спортивных достижений.',
        url: 'https://www.murdochuniversitydubai.com/scholarships/',
      },
    ],
    pathwayPrograms: {
      'Foundation Studies': [
        ...
        ['Foundation — Business Stream', 'foundation', 1, 'foundation'],
        ['Foundation — IT Stream', 'foundation', 1, 'foundation'],
        ['Foundation — Communication Stream', 'foundation', 1, 'foundation'],
      ],
      'Diploma Programs': [
        ['Diploma of Business', 'foundation', 1, 'utp-business'],
        ['Diploma of Information Technology', 'foundation', 1, 'utp-it'],
        ['Diploma of Communication', 'foundation', 1, 'utp-comm'],
      ],
    },
    bachelorPrograms: {
      'Business': [
        ...
        ['Bachelor of Business (Tourism and Events Management)', 'bachelor', 3, 'bachelor-tourism'],
        ['Bachelor of Business (Hospitality and Tourism Management)', 'bachelor', 3, 'bachelor-tourism'],
        ['Bachelor of Business (Entrepreneurship and Innovation)', 'bachelor', 3, 'bachelor-business'],
      ],
      'Information Technology': [
        ['Bachelor of Information Technology (Cyber Security)', 'bachelor', 3, 'bachelor-cyber'],
        ['Bachelor of Information Technology (Internetworking & Cyber Forensics)', 'bachelor', 3, 'bachelor-cyber'],
        ['Bachelor of Information Technology (Mobile and Web Application Development)', 'bachelor', 3, 'bachelor-it'],
        ['Bachelor of Information Technology (Business Information Systems)', 'bachelor', 3, 'bachelor-it'],
        ['Bachelor of Information Technology (Games Software Design and Production)', 'bachelor', 3, 'bachelor-it'],
        ['Bachelor of Information Technology (Data Science and AI)', 'bachelor', 3, 'bachelor-data'],
      ],
      'Communication and Media': [
        ...
        ['Bachelor of Communication (Public Relations)', 'bachelor', 3, 'bachelor-comm'],
        ['Bachelor of Communication (Digital Production)', 'bachelor', 3, 'bachelor-comm'],
        ['Bachelor of Communication (Advertising)', 'bachelor', 3, 'bachelor-comm'],
      ],
      'Arts and Humanities': [
    ...
    masterPrograms: {
      ...
      'Information Technology': [
        ['Master of Information Technology (Cyber Security)', 'master', 1.5, 'master-cyber'],
        ['Master of Information Technology', 'master', 1.5, 'master-it'],
        ['Master of Data Science and Artificial Intelligence', 'master', 1.5, 'master-it'],
      ],
      'Communication': [
        ['Master of Communication and Media Management', 'master', 1.5, 'master-comm'],
      ],
    },
  },
];
...
const ID_UNIS = [
  {
    ...
    feeBand: {
      ...
      'utp-business': 11500,
      'utp-it': 11500,
      'utp-engineering': 12000,
      'bachelor-business': 13500,
      'bachelor-finance': 13500,
      'bachelor-econ': 13500,
      'bachelor-it': 14500,
      'bachelor-data': 14500,
    ...
    accommodation: [
      ...
      { name: 'DLI Bandung On-Campus Hostel', price: 'от AU$250/мес', text: 'On-campus hostel с общей кухней — для первокурсников DLI.' },
      { name: 'Homestay через DLI Bandung', price: 'от AU$280/мес', text: 'Индонезийская хост-семья в Бандунге — питание и комната, идеально для адаптации.' },
    ],
    campuses: [
    ...
    extraScholarships: [
      {
        name: 'DLI Bandung Academic Excellence Scholarship',
        nameRu: 'DLI Bandung Academic Excellence Scholarship',
        amount: 'до AU$2,500',
        description: 'Merit-based scholarship for top international applicants entering DLI Bachelor.',
        descriptionRu: 'Стипендия за академические достижения для outstanding международных абитуриентов бакалавриата DLI.',
        url: 'https://www.dli.ac.id/scholarships/',
      },
      {
        name: 'DLI Bandung Founding Cohort Scholarship',
        nameRu: 'DLI Bandung Founding Cohort Scholarship',
        amount: 'до AU$3,000',
        description: 'For early-cohort students entering DLI as the university scales up — limited cohort scholarship.',
        descriptionRu: 'Для early-cohort студентов на этапе масштабирования DLI — ограниченное количество мест.',
        url: 'https://www.dli.ac.id/scholarships/',
      },
      {
        name: 'DLI Pathway Progression Award',
        nameRu: 'DLI Pathway Progression Award',
        amount: 'до AU$1,500',
        description: 'For Foundation/Diploma students progressing into a DLI Bachelor degree.',
        descriptionRu: 'Для Foundation/Diploma студентов, переходящих в бакалавриат DLI.',
        url: 'https://www.dli.ac.id/scholarships/',
      },
    ],
    pathwayPrograms: {
      'Foundation Studies': [
        ...
        ['Foundation — Business Stream', 'foundation', 1, 'foundation'],
        ['Foundation — Computing Stream', 'foundation', 1, 'foundation'],
      ],
      'Diploma Programs': [
        ['Diploma of Business', 'foundation', 1, 'utp-business'],
        ['Diploma of Information Technology', 'foundation', 1, 'utp-it'],
        ['Diploma of Engineering', 'foundation', 1, 'utp-engineering'],
      ],
    },
    bachelorPrograms: {
      'Business and Management': [
        ...
        ['BSc (Hons) Accounting and Finance — dual', 'bachelor', 3, 'bachelor-finance'],
        ['BSc (Hons) Economics — dual', 'bachelor', 3, 'bachelor-econ'],
        ['BSc (Hons) Marketing — dual', 'bachelor', 3, 'bachelor-business'],
        ['BSc (Hons) Entrepreneurship — dual', 'bachelor', 3, 'bachelor-business'],
      ],
      'Computing and IT': [
        ['BSc (Hons) Computer Science — Deakin + Lancaster dual', 'bachelor', 3, 'bachelor-it'],
        ['BSc (Hons) Data Science — dual', 'bachelor', 3, 'bachelor-data'],
        ['BSc (Hons) Software Engineering — dual', 'bachelor', 3, 'bachelor-it'],
        ['BSc (Hons) Cyber Security — dual', 'bachelor', 3, 'bachelor-it'],
      ],
      'Engineering': [
        ['BEng (Hons) Mechatronic Engineering — dual', 'bachelor', 4, 'bachelor-engineering'],
        ['BEng (Hons) Mechanical Engineering — dual', 'bachelor', 4, 'bachelor-engineering'],
        ['BEng (Hons) Electrical Engineering — dual', 'bachelor', 4, 'bachelor-engineering'],
      ],
    },
    masterPrograms: {
      'Business': [
