...
// Школы, у которых в каталоге есть карточка с программами (9 из живых 12). Программы
// собирались майским scrape-cats-all (удалён 20.09.2026); страницы школ прозаические,
// общий разбор даёт оглавления и таблицы поступлений вместо предметов, поэтому
// коллектора программ в КОМПАСе нет — только состав.
...
await writeMembership(AGG, {
  _meta: {
    ...
    notes: [
      ...
      'Майские scrape-cats-all и expand-cats-programs удалены 20.09.2026: писали в живой каталог напрямую и раздавали цены из литеральной таблицы в коде.',
      'Коллектора программ нет: страницы школ прозаические (замер 20.09 — 11 из 24 адресов мертвы, общий разбор даёт оглавления и таблицы поступлений). Программы в карточках остаются майскими, пока владелец не решит, нужны ли школам обновляемые программы.',
    ],
  },
  schools,
