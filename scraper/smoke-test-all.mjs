...
// Все коллекторы здесь — поколения КОМПАСа: Kaplan (сухой прогон), GEDU (один бренд без
// браузера), Collab (один вуз, сухой прогон), CATS (состав сети, сухой прогон). Edvoy, IAPro, QS, Study Group, QAHE, Navitas и Oxford International
...
const COLLECTORS = [
  ...
  { name: 'cats',            script: 'kompas-collect-cats.mjs',         args: ['--dry-run'],  needsEnv: [] },
